...
const CircularButton = ({ handleClick, buttonDisabled }) => {
  ...
  setTimeout(() => {
    if (ref.current) {
      ...
      refnew.current.style.opacity = 1;
    }
  }, 1000);
  ...
  return (
    <div className="circular-btn-container">
      <div
        className="main-screen-loader"
        onClick={handleClick}
        disabled={buttonDisabled}
      >
        <div className="CircularButton">
          <div className="loading manual-loading">
            <span></span>
            <span></span>
            <span style={{ opacity: 0 }} ref={refnew}></span>
            <span></span>
          </div>
        </div>
        <div className="loader-container">
          <div className="loader rotate-off">
            <svg
            ...
            <div className="loading">
              <span></span>
              <span></span>
              <span style={{ opacity: 0 }} ref={ref}></span>
              <span></span>
            </div>
          </div>
        </div>
