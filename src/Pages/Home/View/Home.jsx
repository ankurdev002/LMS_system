        ...
        <div className="container-home-render">
          <div className="first-home-cont-2">
            <div className="my-container">
              ...
              <button onClick={() => setDisplayMyTask(true)}>
                <svg
            ...
            <div className="my-container">
              ...
              <button onClick={() => setDisplayDateJournal(true)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 448 512"
            ...
            <div className="my-container">
              ...
              {isHovered && <div className="counter">{unreadNoticeCount}</div>}
            </div>

            <div className="my-container">
              <div className="profile-details-bg"></div>

              <button onClick={() => setDisplayMyResources(true)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 448 512"
